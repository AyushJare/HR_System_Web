        ...
        <table className="w-full text-sm">
          <thead className="bg-slate-50 border-b border-slate-200">
            <tr>
              ...
              <th className="text-left px-4 py-3 font-medium text-slate-600">Designation Name</th>
            </tr>
          </thead>
          <tbody>
            {loading && (
            ...
            {!loading && items.length === 0 && (
              <tr><td colSpan={2} className="px-4 py-6 text-center text-slate-400">No designations yet.</td></tr>
            )}
            {items.map((item) => (
