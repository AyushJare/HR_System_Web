        ...
        {showForgotPassword ? (
          ...
          >
            ...
            <div>
              ...
              {/* ================================================== */}
              {/* PASSWORD INPUT + PRESS-AND-HOLD EYE */}
              {/* ================================================== */}
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-md border border-slate-300 px-3 py-2 pr-12 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="********"
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-2 flex items-center justify-center px-1 text-slate-400 hover:text-slate-600 cursor-pointer select-none"                >
                  <svg
